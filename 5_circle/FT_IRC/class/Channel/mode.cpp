...
bool Channel::I_Option(Client *client, std::string flag)
{
...
bool Channel::T_Option(Client *client, std::string flag)
{
	std::ostringstream msg;
...
bool Channel::K_Option(Client *client, std::string flag, std::string str)
{
	std::ostringstream msg;
...
bool Channel::L_Option(Client *client, std::string flag, std::string str)
{
	std::ostringstream msg;
